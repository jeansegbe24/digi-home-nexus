...
const DoorOpen = createLucideIcon("door-open", __iconNode$H);
const __iconNode$G = [
...
const Pill = createLucideIcon("pill", __iconNode$l);
const __iconNode$k = [
...
const Plug = createLucideIcon("plug", __iconNode$k);
const __iconNode$j = [
